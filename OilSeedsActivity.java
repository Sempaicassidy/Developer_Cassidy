...
public class OilSeedsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oil_seeds);
        ...
        List<Product> productFromDatabase = dbHelper. getProductsByCategory("Oilseeds");

        if (productFromDatabase != null && !productFromDatabase.isEmpty()) {
            productList.addAll(productFromDatabase);
            productAdapter.notifyDataSetChanged();
        } else {
            Log.d("OilSeedsActivity", "No Products found in the database");
        }
    }
}